...
const Skills = () => {
  return (
    <div className='Skills py-5 bg-dark'>
      <div className='container'>
        <h2 className='text-white text-center text-uppercase mb-5'>Skills</h2>
        <ul className='list-inline text-center mx-auto skill-icons'>
